...
description: >-
  ...
  da casa", ou perguntar se um manifesto passa na revisão do Seraph ou está no padrão — mesmo
  sem citar o padrão e mesmo que o arquivo ainda não tenha sido enviado (carregue a skill
  antes de procurar o arquivo; ela diz o que pedir).
...
## Se o manifesto não veio junto

"Esse manifesto está no padrão?" sem arquivo anexado é comum. Não vasculhe o disco atrás de YAML
solto: peça o caminho, o conteúdo colado ou o repositório, e avise que o repositório da
aplicação também é necessário para a metade contextual da conferência.
