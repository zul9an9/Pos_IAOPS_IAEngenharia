$ python3 skill/metacortex-manifests/scripts/conferir.py variante-exemplo-do-padrao
# Conferência — Padrão de Manifests da Metacortex (rev. 2026-07-29)

Entrada: variante-exemplo-do-padrao  
Trivy: executado
...
- **3.3** `Deployment/nyx-api` — confrontar as variáveis entregues ['DATABASE_URL'] com as que o código lê, e decidir quais são sensíveis
