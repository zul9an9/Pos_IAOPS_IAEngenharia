...
# Justificativa de modelo Claude Opus 4.7
Claude Opus 4.7 (ou modelo equivalente de alta capacidade com bom seguimento de instruções e raciocínio sobre infraestrutura). A tarefa exige (i) consistência em comandos de shell, (ii) raciocínio condicional entre passos, (iii) aderência estrita a um formato. Modelos menores tendem a omitir verificações ou inventar flags inexistentes em kubectl/argocd cli.
